# Remote Transport Protocol Specification

## Purpose
Define end-to-end encrypted Host-to-Client transport, binary application frames, and one-time pairing-code representation.
