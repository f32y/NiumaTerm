...
mod tests {
    ...
    struct ChatTestView {
        ...
        composer: Entity<crate::input::InputState>,
    ...
    impl ChatTestView {
        fn new(second_selectable: bool, window: &mut Window, cx: &mut Context<Self>) -> Self {
            Self {
                ...
                composer: cx.new(|cx| crate::input::InputState::new(window, cx)),
    ...
    impl Render for ChatTestView {
        fn render(&mut self, _: &mut Window, _: &mut Context<Self>) -> impl IntoElement {
            ...
            let restore = self.restore_composer_on_mouse_up;
            ...
            div()
                ...
                .child(crate::input::Input::new(&self.composer))
        }
    }
    ...
    fn focused_composer_preserves_transcript_copy_and_paste(cx: &mut TestAppContext) {
        ...
        cx.write_to_clipboard(gpui::ClipboardItem::new_string("old clipboard".to_string()));
