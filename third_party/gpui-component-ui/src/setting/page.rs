...
use gpui::{
    ...
    ParentElement as _, SharedString, StyleRefinement, Styled, Window, div, list, px,
};
use rust_i18n::t;
...
use crate::setting::settings::SettingsState;
use crate::setting::{RenderOptions, SettingGroup};
use crate::{ActiveTheme, Icon, IconName, Sizable, StyledExt, h_flex, v_flex};
