...
pub struct SettingGroup {
    ...
    /// Per-group override of the settings-wide group-box variant.
    variant: Option<crate::group_box::GroupBoxVariant>,
}
...
impl SettingGroup {
    ...
    /// Override the group-box variant for this group only (the default comes
    /// from [`super::Settings::with_group_variant`]).
    pub fn variant(mut self, variant: crate::group_box::GroupBoxVariant) -> Self {
