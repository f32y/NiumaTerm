...
use crate::{
    ...
    RenderImage, RenderImageParams, RenderSvgParams, ScaledPixels, Scene, ShapedGlyph, ShapedRun,
...
pub trait PlatformWindow: HasWindowHandle + HasDisplayHandle {
    ...
    /// Present a rendered scene. `damage` contains changed regions in physical pixels.
