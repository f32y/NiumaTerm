...
use libghostty_vt_sys::{
    ...
    TerminalScrollbar as VtTerminalScrollbar, ghostty_block_ref_placement_pos, ghostty_cell_get,
    ...
    ghostty_render_state_update, ghostty_row_get_multi, ghostty_terminal_free,
    ghostty_terminal_get, ghostty_terminal_grid_ref, ghostty_terminal_mode_get,
    ghostty_terminal_new, ghostty_terminal_point_from_grid_ref, ghostty_terminal_resize,
