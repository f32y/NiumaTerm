...
pub(crate) fn history_events(payload: &Value) -> Vec<Event> {
...
pub(crate) fn search_events(payload: &Value) -> Vec<Event> {
...
pub(crate) fn models_with_image(models: &Value, model: &str, field: &str) -> Option<Value> {
