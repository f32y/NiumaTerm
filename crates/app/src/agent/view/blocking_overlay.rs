...
#[derive(IntoElement)]
pub(in crate::agent::view) struct BlockingOverlay {
    body: AnyElement,
    padded: bool,
}

impl BlockingOverlay {
    pub(in crate::agent::view) fn new(body: impl IntoElement) -> Self {
        Self {
    ...
    pub(in crate::agent::view) fn padded(mut self) -> Self {
        self.padded = true;
        self
    }
}
