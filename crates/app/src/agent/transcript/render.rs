...
impl TranscriptView {
    ...
    pub(in crate::agent) fn render_row(
        &mut self,
        ix: usize,
        window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(in crate::agent) fn render_working_row(
        &self,
        compacting: bool,
        cx: &mut Context<Self>,
    ) -> AnyElement {
    ...
    pub(in crate::agent) fn render_entry_row(
        &mut self,
        index: usize,
        window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(in crate::agent) fn hover_stamp(&self, index: usize, cx: &mut Context<Self>) -> Div {
        div()
            .flex_none()
            .text_xs()
    ...
    pub(in crate::agent) fn render_user_row(
        &self,
        index: usize,
        text: &str,
        cx: &mut Context<Self>,
    ...
    pub(in crate::agent) fn render_agent_row(
        &self,
        index: usize,
        text: String,
        cx: &mut Context<Self>,
    ...
    pub(in crate::agent) fn render_error_row(
        &self,
        index: usize,
        text: String,
        cx: &mut Context<Self>,
    ...
    pub(in crate::agent) fn render_work_row(
        &mut self,
        index: usize,
        window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(in crate::agent) fn render_compaction_row(
        &self,
        index: usize,
        detail: Compaction,
        window: &mut Window,
    ...
    pub(in crate::agent) fn render_compaction_detail(
        &self,
        index: usize,
        detail: &Compaction,
        window: &mut Window,
    ...
    pub(in crate::agent) fn render_turn_fold(
        &self,
        turn: u64,
        row_count: usize,
        folded: bool,
    ...
    pub(in crate::agent) fn render_turn_summary(
        &self,
        seconds: u64,
    ...
    pub(in crate::agent) fn render_interrupted_row(
        &self,
        output_tokens: Option<u64>,
        cx: &mut Context<Self>,
    ) -> AnyElement {
    ...
    pub(in crate::agent) fn render_run_toggle(
        &self,
        run_start: usize,
        tool_count: usize,
        expanded: bool,
