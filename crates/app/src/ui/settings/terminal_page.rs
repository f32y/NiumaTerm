        ...
        .group(
            SettingGroup::new()
                ...
                .item(
                    ...
                    .description(i18n("settings-terminal-input-style-description")),
                )
                .item(
                    SettingItem::new(
                    ...
                    .description(i18n("settings-terminal-cursor-shape-description")),
                )
                .item(
                    SettingItem::new(
                    ...
                    .description(i18n("settings-terminal-command-blocks-description")),
                )
                .item(
                    SettingItem::new(
                    ...
                    .description(i18n("settings-terminal-scroll-on-typing-description")),
                ),
        )
}
