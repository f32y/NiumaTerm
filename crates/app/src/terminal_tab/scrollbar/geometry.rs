...
pub(in crate::terminal_tab) const SCROLLBAR_AUTO_HIDE_DELAY: time::Duration =
    time::Duration::from_millis(500);

pub(in crate::terminal_tab) const SCROLLBAR_FADE_OUT_DURATION: time::Duration =
    time::Duration::from_millis(200);

pub(in crate::terminal_tab) fn scrollbar_thumb_geometry(
    total: f64,
    offset: f64,
    len: f64,
) -> Option<(f32, f32)> {
...
pub(in crate::terminal_tab) fn scrollbar_offset_for_thumb(
    total: f64,
    len: f64,
    thumb_top: f32,
) -> Option<f64> {
...
pub(in crate::terminal_tab) fn scrollbar_opacity(
    dragging: bool,
