...
pub(in crate::agent_pane::updates) struct UnavailableMaintenance {
    pub(in crate::agent_pane::updates) provider: ProviderKind,
    pub(in crate::agent_pane::updates) reason: String,
}
...
pub(in crate::agent_pane::updates) struct FakeMaintenance {
    provider: ProviderKind,
    updated: AtomicBool,
}

impl FakeMaintenance {
    pub(in crate::agent_pane::updates) fn new(provider: ProviderKind) -> Self {
        Self {
            provider,
