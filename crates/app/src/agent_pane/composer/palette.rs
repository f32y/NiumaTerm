...
#[derive(Clone)]
pub(in crate::agent_pane) enum PaletteAction {
...
#[derive(Clone)]
pub(in crate::agent_pane) struct PaletteRow {
    pub(in crate::agent_pane) label: String,
    pub(in crate::agent_pane) description: String,
    pub(in crate::agent_pane) hint: Option<String>,
    pub(in crate::agent_pane) disabled_reason: Option<String>,
    pub(in crate::agent_pane) action: PaletteAction,
}

pub(in crate::agent_pane) struct PaletteModel {
    pub(in crate::agent_pane) rows: Vec<PaletteRow>,
    pub(in crate::agent_pane) note: Option<String>,
}

#[derive(Clone, Copy)]
pub(in crate::agent_pane) enum PaletteControl {
    Previous,
    Next,
    Activate,
    Complete,
...
impl AgentPane {
    pub(in crate::agent_pane) fn open_recent_sessions(&mut self, cx: &mut Context<Self>) -> bool {
    ...
    pub(in crate::agent_pane) fn handle_palette_control(
        &mut self,
    ...
    pub(in crate::agent_pane) fn activate_palette_index(
        &mut self,
        index: usize,
        execute: bool,
        window: &mut Window,
    ...
    pub(in crate::agent_pane) fn render_command_palette(
        &self,
        cx: &mut Context<Self>,
    ) -> Option<AnyElement> {
