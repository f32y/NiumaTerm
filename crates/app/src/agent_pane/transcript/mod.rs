...
pub(super) use crate::agent_pane::transcript::format::{
    command_execution_detail, compact_token_count, compaction_accounting, compaction_label,
    compaction_row_is_expandable, detect_output_language, entry_copy_text, fenced_code_block_as,
