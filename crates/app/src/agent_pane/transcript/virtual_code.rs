use crate::agent_pane::transcript::{
    detect_output_language, file_extension_lang, strip_read_gutter,
};
...
pub(in crate::agent_pane) fn should_virtualize_transcript(code: bool, text: &str) -> bool {
...
pub(in crate::agent_pane) struct TranscriptSourceKey {
    allocation: usize,
    len: usize,
    edge_hash: u64,
...
pub(in crate::agent_pane) fn transcript_source_key(
    text: &str,
    strip_read_gutter: bool,
) -> TranscriptSourceKey {
...
pub(in crate::agent_pane) fn transcript_segments(text: &str) -> Vec<Range<usize>> {
...
pub(in crate::agent_pane) struct VirtualTranscriptState {
...
pub(in crate::agent_pane) fn normalized_virtual_transcript(
    text: &str,
    strip_gutter: bool,
) -> String {
    if strip_gutter {
...
pub(in crate::agent_pane) fn code_transcript_format(
    item: &SessionItem,
    detail: &str,
