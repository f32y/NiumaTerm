...
use crate::thread_controls::{
    EFFORT_GAUGE_STEPS, EFFORT_LEVELS, EFFORT_THUMB_INSET, EFFORT_TRACK_HEIGHT,
    SETTINGS_PILL_CHEVRON, SETTINGS_PILL_ICON, SETTINGS_PILL_TEXT, settings_pill,
    settings_pill_frame,
};
                ...
                .child(
                    div()
                        ...
                        .children(thumb.map(|index| {
                            div()
                                .absolute()
                                .top(EFFORT_THUMB_INSET)
                                .bottom(EFFORT_THUMB_INSET)
